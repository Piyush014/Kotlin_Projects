package com.piyush.ipcclient.ui.messenger
...
import com.piyush.ipcclient.*
import com.piyush.ipcclient.databinding.FragmentMessengerBinding
...
class MessengerFragment : Fragment(), ServiceConnection, View.OnClickListener {
    ...
    private fun doBindService() {
        ...
        Intent("messengerexample").also { intent ->
            intent.`package` = "com.piyush.ipcserver"
